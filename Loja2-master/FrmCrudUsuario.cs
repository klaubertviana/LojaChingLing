    ...
    public partial class FrmCrudUsuario : Form {
        ...
        private void btnCadastro_Click ( object sender , EventArgs e ) {
            try {
                ...
                cmd.Parameters.AddWithValue ( "@senha" , encoder.Base64Encode(txtSenha.Text) );
                Class1.obterConexao ( );
                cmd.ExecuteNonQuery ( );
                CarregaDgvUsuario ( );
        ...
        private void btnEditar_Click ( object sender , EventArgs e ) {
            try {
                ...
                cmd.Parameters.AddWithValue ( "@senha" , encoder.Base64Encode(this.txtSenha.Text) );
                Class1.obterConexao ( );
                cmd.ExecuteNonQuery ( );
                CarregaDgvUsuario ( );
